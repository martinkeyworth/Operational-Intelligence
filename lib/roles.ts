...
export const ROLES: RoleDef[] = [
  ...
  },
  {
    ...
    reportsTo: "gm",
    purpose:
      "Runs a single site end to end — the role every barber, assistant and apprentice reports into. Holds site-level RTB, utilisation, staffing, standards and the 10% gross bonus model.",
    ownsAreas: ["Capacity", "RTB"],
    responsibilities: [
      "Hit site RTB, utilisation and revenue targets.",
      "Manage the on-site team, rota and daily standards.",
      "Own local stock, opening/closing and customer experience.",
    ],
    kpis: ["Site RTB", "Chair utilisation", "Customer reviews"],
    routingKeywords: ["shop manager", "site manager", "store manager"],
  },
  {
    key: "academy-trainer",
    ...
    purpose:
      "Delivers training and assesses apprentices through their NVQ — the apprentices' training-side reporting line, core to Ravi's academy remit.",
    ownsAreas: ["Training"],
    responsibilities: [
      "Deliver academy and in-shop training sessions.",
      "Assess apprentice progress against NVQ milestones.",
      "Feed apprentice readiness back to shop managers and Ravi.",
    ],
